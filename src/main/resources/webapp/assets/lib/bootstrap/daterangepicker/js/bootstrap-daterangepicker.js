        ...
        clickDate: function (e) {
            ...
            if (cal.hasClass('left')) {
                ...
                if (typeof this.dateLimit === 'object') {
                    var maxDate = new Date(startDate).addDays(this.dateLimit.days);
                    if (endDate.isAfter(maxDate) || startDate.isAfter(endDate)) {
                        if(this.maxDate){
                            if(maxDate.isBefore(this.maxDate)){
                                endDate = maxDate;
                            }else{
                ...
                if (typeof this.dateLimit === 'object') {
                    var minDate = new Date(endDate).addDays((-1 * this.dateLimit.days));
                    if (startDate.isBefore(minDate) || endDate.isBefore(startDate)) {
                        if(this.minDate){
                            if (minDate.isAfter(this.minDate)) {
                                startDate = minDate;
                            }else{
