...
!function( $ ) {
	...
	var Datetimepicker = function(element, options) {
		...
		this.language = options.language || this.element.data('date-language') || "ch_ZN";
		this.language = this.language in dates ? this.language : "ch_ZN";
	...
	Datetimepicker.prototype = {
		...
		place: function(){
            ...
            // FIXME MOD!
			var ps = this.element.parents();
			var eles = ps.filter(function() {
				return $(this).css('z-index') != 'auto' && !$(this).hasClass('modal');  // MOD! && !$(this).hasClass('modal');
			});
			var zIndex = parseInt(eles.first().css('z-index')) + 10;
			var offset, top, left;
			if (this.component) {
